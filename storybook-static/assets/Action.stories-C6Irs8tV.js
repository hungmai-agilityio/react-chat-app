import{o as R}from"./index-BrXc1ilD.js";import{j as e}from"./jsx-runtime-Cw0GR0a5.js";import{r as j}from"./index-CTjT7uj6.js";import{S as d,T as o}from"./enum-DHbXvcqL.js";import{c as H}from"./convert-C4t-ChUr.js";import{A as k}from"./index-Hcv-Sshn.js";import{I as w}from"./index-BBwjF1qp.js";import{B as L}from"./index-BWw-Y-iC.js";import"./clsx-B-dksMZM.js";import"./index-Ya2q_kcw.js";import"./index.es-D6nAsfRb.js";import"./index-BzjuzjN8.js";const h=({avatar:T,name:a,btnName:s,onClick:E,onChange:x,icon:C,onAvatarChange:i})=>{const r=j.useRef(null),A=async M=>{const m=M.target.files,c=m&&m[0];if(c){const I=await H(c);i&&i(I)}},y=()=>{r.current&&r.current.click()};return e.jsxs("div",{className:"relative mt-5",children:[e.jsxs("div",{className:"absolute left-1/2 transform -translate-x-1/2",children:[e.jsx(k,{name:a,avatar:T||"",size:d.LARGE,onClick:y,styles:"rounded-lg"}),e.jsx("input",{ref:r,onChange:A,id:"upload",type:o.FILE,className:"hidden",accept:"image/*","data-testid":"file-input"})]}),e.jsx("div",{className:"absolute top-32 left-1/2 transform -translate-x-1/2",children:e.jsx("div",{className:"mt-4 w-72",children:e.jsx(w,{placeholder:"Chat name",variant:o.TERTIARY,value:a||"",onChange:x})})}),s&&e.jsx("div",{className:"absolute top-lg right-xs",children:e.jsx(L,{name:s,onClick:E,iconRight:C,variant:o.PRIMARY,size:d.MEDIUM,disabled:!(a!=null&&a.trim())})})]})};h.__docgenInfo={description:"",methods:[],displayName:"ModalAction",props:{btnName:{required:!1,tsType:{name:"string"},description:""},onClick:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},icon:{required:!1,tsType:{name:"IconDefinition"},description:""},avatar:{required:!1,tsType:{name:"string"},description:""},name:{required:!1,tsType:{name:"string"},description:""},onChange:{required:!0,tsType:{name:"signature",type:"function",raw:`(\r
